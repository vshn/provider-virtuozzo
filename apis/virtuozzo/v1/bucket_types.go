...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,virtuozzo}
// +kubebuilder:webhook:verbs=update,path=/validate-virtuozzo-crossplane-io-v1-bucket,mutating=false,failurePolicy=fail,groups=virtuozzo.crossplane.io,resources=buckets,versions=v1,name=buckets.virtuozzo.crossplane.io,sideEffects=None,admissionReviewVersions=v1
